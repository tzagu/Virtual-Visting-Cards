  ...
  <v-app id="inspire" class="inspire">
    ...
    >
      <template v-slot:activator="{ on, attrs }">
          <v-btn class="white--text" color="#36213e" v-bind="attrs"
          v-on="on">Contact Partner</v-btn>
      </template>
    ...
    >
      <template v-slot:activator="{ on, attrs }">
          <v-btn class="white--text" color="#36213e" v-bind="attrs"
          v-on="on">Request Quotation</v-btn>
      </template>
